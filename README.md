...
5. You should normalize your training data and redo the experiments. You could use the [normalization code from here](https://github.com/alimoorreza/CS167-fall26-notes/blob/main/Day07_Normalization.ipynb). Make a copy of the original data (the Pandas `copy()` function will be useful), and then normalize the training data using **z-score** normalization.
